...
const statusConfig: Record<ConversationStatus, { label: string; className: string }> = {
  ...
  waiting: { label: 'המתנה', className: 'bg-yellow-100 text-yellow-800' },
  handoff: { label: 'העברה', className: 'bg-red-100 text-red-800' },
  human_active: { label: 'נציג', className: 'bg-purple-100 text-purple-800' },
  paused: { label: 'מושהה', className: 'bg-gray-100 text-gray-800' },
  closed: { label: 'סגור', className: 'bg-gray-100 text-gray-500' },
};
